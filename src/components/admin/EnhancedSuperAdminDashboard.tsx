        ...
        <Card className="max-w-md w-full">
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 mb-6">
              슈퍼 관리자 권한이 필요한 페이지입니다.
            </p>
            <div className="space-y-2 text-sm">
              <p>현재 사용자: <span className="font-medium">{authUser?.username || 'Unknown'}</span></p>
              <p>권한 레벨: <span className="font-medium">
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center gap-4">
                  ...
                  <span className="px-4 py-2 text-sm font-semibold text-white bg-red-600 rounded-full">
                    🔴 Super Admin: {authUser?.username || 'aebon'}
                  </span>
                </div>
