          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-8">
              <Button 
                ...
                className={`${
                  activeView === 'intro' 
                    ? 'bg-gradient-to-r from-blue-500 to-cyan-500 text-white shadow-xl border-0' 
                    : 'bg-gradient-to-r from-blue-400 to-cyan-400 hover:from-blue-500 hover:to-cyan-500 text-white border-0 hover:shadow-lg'
              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <Button 
                    ...
                    size="lg"
                    onClick={onLoginClick}
                    className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 px-12 py-4 text-lg font-semibold"
                  >
                    서비스 시작하기
                  </Button>
                  <Button 
